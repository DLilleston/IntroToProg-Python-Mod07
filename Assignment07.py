...
#   Danielle Lilleston, 05/28/2024, Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
        - Lilleston, 05/28/2024, Created the class.
    """
...
class Student(Person):
    ...
    Lilleston, 05/28/2024, Created Class
    """
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        Lilleston, 05/28/2024, Created Function
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        ChangeLog: (Who, When, What)
        Lilleston, 05/25/2024,Created function
